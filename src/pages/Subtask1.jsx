        ...
        <Container>
            ...
            <Box mb={4}>
                ...
                >
                    ...
                    <MenuItem value="opcion1" style={{ color: 'white', backgroundColor: '#ff6600' }}>WINTV BASICO</MenuItem>
                    <MenuItem value="opcion2" style={{ color: 'white', backgroundColor: '#ff6600' }}>WINTV PLUS </MenuItem>
                    <MenuItem value="opcion3" style={{ color: 'white', backgroundColor: '#2e9fe1' }}>DGO L1MAX</MenuItem>
                    <MenuItem value="opcion4" style={{ color: 'white', backgroundColor: '#2e9fe1' }}>DGO BASICO</MenuItem>
                    <MenuItem value="opcion5" style={{ color: 'white', backgroundColor: '#2e9fe1' }}>DGO FULL</MenuItem>
                    <MenuItem value="opcion6" style={{ color: 'white', backgroundColor: '#ff6600' }}>FONOWIN </MenuItem>
